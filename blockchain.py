# -*- coding: utf-8 -*-
"""
Created on Sat Jun  2 06:00:56 2018
...
class Blockchain:
    def __init__(self):     #self is the object here and we are initializing our blockchain with two variables
        self.chain = []     # initialize our chain with empty list
        self.create_block(proof=1,previous_hash='0')        #genesis block
        
    def create_block(self,proof,previous_hash):        #we will use this create_block function right after the block is mined
        block = {
